...
- *no ouliters showed in plot, but for influential points, cook's distance high, but < 0.5. include or exclude?*
- multicollinearity checked. no correlated varibales, as all are categorical predictors
