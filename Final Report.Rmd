...
**Figure 6** demonstrates the results of boxcox method: the log-likelihood over boxcox method parameter $\lambda$. The biggest likelihood is at around $\lambda=1$, showing that there’s no need for transformation.
