...
three response score variables are demonstrated in **Figure 1**
...
stepwise regression. Moreover, **Figure 3**, **Figure 4**, and
**Figure 5** display the diagnostic plots generated by the model.
...
mtext(text = main_title, side = 3, line = -1, outer = TRUE, cex = 1.2, font = 2)
```
