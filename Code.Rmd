...
```{r}
# backward model
model_math_fit_back = step(model_math_full, direction='backward')
...
```{r}
# backward model
model_reading_back = step(model_reading_full, direction='backward')
...
```{r}
# backward model
model_writing_back = step(model_writing_full, direction = "backward")
