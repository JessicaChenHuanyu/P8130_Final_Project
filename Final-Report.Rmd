...
Residuals, Scale-Location, and Residuals vs Leverage.
Next, we use BIC-based procedures to select the appropriate subsets of
predictors for three subjects.
...
$\lambda$, and then fitted LASSO model with this optimal value.
...
among three score variables. Then we refitted the linear
...
predictors. The VIFs are calculated for all
